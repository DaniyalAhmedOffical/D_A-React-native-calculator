...
export default function App() {
  ...
  return (
    <View>
      <View>
        <Text style={{textAlign : 'center' , fontFamily:'ALAGERIN', fontSize:'20PX', marginBottom:'8PX', marginTop:'8PX', backgroundColor:'#FF8111'}}>
          MADE BY DANIYAL AHMED
        </Text>
      </View>
      ...
      <View style={styles.buttons}>
        {buttons.map((btn) =>
          btn === '=' || btn === '/' || btn === '*' || btn === '-' || btn === '+' ?
            <TouchableOpacity key={btn} style={[styles.button, { backgroundColor: '#FF8111' }]} onPress={() => handleInput(btn)}>
